...
class Taekwondo(Zawodnik, threading.Thread):

    def __init__(self, plansza):
        super().__init__(plansza)
        #super().super().__init__()
        threading.Thread.__init__(self)
        self.kim_jestem = 1000

    def kopniecie(self):#142, 144, 146, 148, 150, 152, 154, 156
        ...
        if self.plansza.wspolrzedne_w_planszy(x, y) and self.plansza.plansza[y][x] != None:
            self.plansza.plansza[y][x].zostan_kopniety(10, 2)
            self.ile_ciosow_otrzymalem_w_serii = 0
